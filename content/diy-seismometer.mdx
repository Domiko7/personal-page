...
If you are using an ESP32 micro-controller with an ADS1256 ADC, here is the default pin mapping used in firmware configuration:
...
* **Discord:** Join the community server linked on [nexaseis.domiko.dev](https://nexaseis.domiko.dev)
