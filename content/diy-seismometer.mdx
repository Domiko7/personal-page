...
Digital filtering implementation for this setup is taken directly from my old [ESP32 AnyShake Explorer firmware repository](https://github.com/Domiko7/ESP32-anyshake-explorer), which provides the routines for both second-order sections (SOS) pre-processing and DF1 response extension.
